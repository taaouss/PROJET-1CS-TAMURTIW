...
const SideBar = ({isOpen,toggle}) => {
    ...
    return (
        <SideBarContainer isOpen={isOpen} onClick={toggle}>
            ...
            <SideBarWrapper>
                <SideBarMenu>
                    <SideBarLink onClick={toggle} to='about'>À propos</SideBarLink>
                    <SideBarLink onClick={toggle} to='discover'>Nos Services</SideBarLink>
                    <SideBarLink onClick={toggle} to='services'>Nos Destinations</SideBarLink>
                    <SideBarLink_tmp onClick={toggle} to='/Signin/SigninUser/Main/recherche' >Nos témoignages</SideBarLink_tmp>
